...
public class UpdateQueryTest {
	...
	public void parseUpdateWithParametersAndRows() {
		...
		String expected12 = "UPSERT INTO TRADE (column1, column2) VALUES ('value1', 'value2') WHERE condition1 = 'conditionValue1' AND condition2 = 'conditionValue2'";// AND StorageTimestime < ";
		String expected21 = "UPSERT INTO TRADE (column1, column2) VALUES ('value1', 'value2') WHERE condition2 = 'conditionValue2' AND condition1 = 'conditionValue1'";// AND StorageTimestime < ";
		boolean condition = upsertQueryParsed.equals(expected12) || upsertQueryParsed.equals(expected21);
